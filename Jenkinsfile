pipeline{
    ...
    stages{
        ...
        stage("Git pull"){
            ...
            checkout(
                [
                    ...
                    extensions: [], 
                    userRemoteConfigs: [
                        [url: 'https://github.com/vaibhavraj05/producation-management.git']
                        ]
                ])
            }
        }
            ...
            steps{
                script{
                    def image1 = docker.build(
                        "vaibhavrajnathchauhan/product-management:${BUILD_ID}",
                         "--file Dockerfile ."
                         )
	                image1.push()
                }
        ...
        stage("Removing Image"){
            steps{
                sh "docker rmi -f vaibhavrajnathchauhan/product-management:${BUILD_ID}"
            }
        }
        ...
        stage("Ansible playbook"){
            ...
            ansiblePlaybook credentialsId: '125c65a4-99ea-48f5-8fd5-50bd6c9ac735', 
                ...
                inventory: '/home/ec2-user/tanu/dev.inv' ,
                playbook: '/home/ec2-user/tanu/main.yml' ,
                extraVars   : [
                BUILD_ID: "${ BUILD_ID }"
                ]
            }
